        ...
        <main>
            ...
            <div className='row px-3 py-2 mx-1  border border-muted flex align-items-center'>
                ...
                <div className='col-md-9'>
                    ...
                    <p><b>Likes: </b>{totalLikes}</p>
                    <p><b>Comments:</b>{totalComments}</p>
                    ...
                    <div className='card-footer'>
                        ...
                        <div className=' d-flex justify-content-between align-items-center'>
                            <div className='d-flex justify-content-center align-items-center gap-3'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16" style={{ cursor: "pointer" }}>
                                ...
                                <h6 style={{ cursor: "pointer" }}>Likes: {post.likes.length}</h6>
                            </div>
